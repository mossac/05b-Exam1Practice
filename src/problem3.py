...
def run_test_problem3a():
    ...
    title = 'Problem 4a. Test 4: Start at (30, 30), 1 line'
...
def problem3b(m, point1):
    ...
    # -------------------------------------------------------------------------
    window6 = rg.RoseWindow(450, 600)
    n = 3
    sum = 0
    for _ in range(m):
        add =  problem3a(window6, point1, n)
        sum = sum + add
        point1 = rg.Point(point1.x, point1.y + 60)
        n = n + 2
        window6.continue_on_mouse_click()
    window6.close_on_mouse_click()
    return sum
